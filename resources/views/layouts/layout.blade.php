...
<head>
    ...
    <style>
        ...
        input[type=radio   ]:not(old) + label {
            ...
            margin-left: -28px;
            padding-left: 28px;
            background: url({{asset('assets/images/checks.png')}}) no-repeat 0 0;
            line-height: 24px;
        }
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{route('home')}}">Vamos</a>
                </div>
...
<script src="{{asset('assets/js/jquery-show-first.js')}}"></script>

<script src="{{asset('assets/fancybox/jquery.fancybox.js?v=2.1.4')}}"></script>
