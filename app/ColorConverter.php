...
class ColorConverter
{
    ...
    public function nearestDistance(array $color1, array $color2) {
        return sqrt(pow($color1[0] - $color2[0], 2) +
            pow($color1[1] - $color2[1], 2) +
            pow($color1[2] - $color2[2], 2));
    }

    public function getApproximateColorName($hex){
        $distances = array();
        $val = $this->hex2rgb($hex);
        foreach ($this->colors as $name => $c) {
            $distances[$name] = $this->nearestDistance($c, $val);
        }
